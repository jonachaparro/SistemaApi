...
class usuarios
{
    ...
    public function post($parametros){
            ...
            $query = "INSERT INTO `usuario` (`nombre`, `contrasena`, `correo`, `sexo`, `fechaNacimiento`) VALUES ('$nombre', '$contrasena', '$correo', '$sexo', '$fechaNacimiento');";
            $sentencia = $pdo->prepare($query);
            // Ejecutar sentencia preparada
            if ($sentencia->execute()) {
                http_response_code(200);
